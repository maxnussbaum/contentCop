...
get "/" do
  # response = HTTP.follow.get("https://accounts.spotify.com/authorize?client_id=#{ENV["CLIENT_ID"]}&response_type=code&redirect_uri=http://localhost:4567/callback&scope=playlist-modify-public&show_dialog=true")
  # puts response.to_s
  # @body = response.to_s
  # erb :landing_page
  $a.client_init
...
# post "/api/login" do
#   #puts "#{request.env}"
#   #redirect "http://accounts.spotify.com/api/login"
# end